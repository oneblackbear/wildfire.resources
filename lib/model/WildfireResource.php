...
class WildfireResource extends WaxModel{
  ...
  public function setup(){
    ...
    $this->define("media", "GroupManyToManyField", array('editable'=>false,'target_model'=>"WildfireMedia", "eager_loading"=>true, "join_model_class"=>"WildfireOrderedTagJoin", "join_order"=>"join_order", 'group'=>'media', 'module'=>'media'));
